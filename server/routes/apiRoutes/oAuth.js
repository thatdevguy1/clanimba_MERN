      ...
      axios({
          ...
          .then(function (response2) {
              ...
              axios({
                method: 'get',
                //USKbn2qGYoTlO7ONmb5SJGTNkRhYeKEAeK
                url: `https://us.api.blizzard.com/profile/wow/character/${response2.data.wow_accounts[0].characters[0].realm.slug}/${response2.data.wow_accounts[0].characters[0].name}/charachter-media?access_token=${token.token.access_token}&namespace=profile-us&locale=en_us`
